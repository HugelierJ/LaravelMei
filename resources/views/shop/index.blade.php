                ...
                <div class="d-none d-lg-block col-lg-3 py-3 ms-5">
                    <div class="back-primary w-75 py-5 rounded-3 ff-pm">
                        ...
                        <div class="mt-3 pb-3">
                            ...
                            <ul class="no-style p-0 border-0">
                                <li class="ms-4 ff-pr fs-5"><input class="me-2" type="checkbox" name="male" value="male">Male</li>
                                <li class="ms-4 ff-pr fs-5"><input class="me-2" type="checkbox" name="female" value="female">Female</li>
                                <li class="ms-4 ff-pr fs-5"><input class="me-2" type="checkbox" name="neutral" value="neutral">X</li>
                            </ul>
                        </div>
                        <div>
